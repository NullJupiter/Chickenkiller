...
- Maybe you need to tweak another thing. Set the C++ Standard to C++17 or higher. Go to the project Settings. Then go to `Build Settings` and search for the term `C++ Language Dialect`. There you may change the value to `C++17` or above. Do this for both projects. (Chickenkiller and Asylum-Editor)
