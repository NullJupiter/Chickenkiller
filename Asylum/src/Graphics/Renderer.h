...
namespace Asylum {
	...
	public:
		...
		static void DrawTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID);
		static void DrawTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float zDepth);
		static void DrawTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, const glm::vec3& tint);
		static void DrawTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float zDepth, const glm::vec3& tint);

		// rotated and textured rect draw calls
		static void DrawRotatedTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float angle);
		static void DrawRotatedTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float angle, float zDepth);
		static void DrawRotatedTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float angle, const glm::vec3& tint);
		static void DrawRotatedTexturedRect(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float angle, float zDepth, const glm::vec3& tint);
	...
	private:
		...
		static void DrawTexturedRectImpl(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float zDepth, const glm::vec3& tint);
		static void DrawRotatedTexturedRectImpl(const glm::vec2& position, const glm::vec2& size, uint32_t textureID, float zDepth, const glm::vec3& tint, float angle);
